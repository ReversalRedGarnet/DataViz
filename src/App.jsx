...
import FishBorder from './components/FishBorder.jsx'
...
// colours each divider needs to bound (see SECTION_COLORS in theme.js
// and the two-tone fill in PacificBorder.jsx / FishBorder.jsx).
// 'plain' sections are the interactive canvas (Hero/Storm
...
// Storm profile stays 'plain' rather than becoming a third panel,
// since it's part of the same opening/framing beat as Hero, not a
// separate editorial aside.
//
// Two of the six dividers below use FishBorder instead of
// PacificBorder -- specifically the header/body boundary (right after
// Hero) and the body/footer boundary (right before CitationPanel).
// Every other split uses the wave/spiral motif. Giving fish only those
// two spots is what makes it read as "content starts here" / "content
// ends here" rather than competing with the wave for the same job.
  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen">
        ...
        <FishBorder colorAbove={SECTION_COLORS[heroTone]} colorBelow={SECTION_COLORS[stormTone]} direction="right" />
        ...
        <FishBorder
          colorAbove={SECTION_COLORS[comparisonTone]}
          colorBelow={SECTION_COLORS[FOOTER_TONE]}
          direction="left"
        />
